...
CREATE TABLE `enemy` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=802 DEFAULT CHARSET=utf8 COMMENT='Table of enemies.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-12-06 22:08:05
